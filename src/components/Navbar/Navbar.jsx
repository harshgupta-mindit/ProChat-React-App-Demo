...
const NavbarMenu = () => {
    return (
        <>
            <nav className='nav'>
                <Link style={{textDecoration:'none', color:"#fff"}} to='/'><h1 className='nav-h1'>E-Buy <sub className='nav-sub'></sub></h1></Link>
                ...
                <div className="nav-ul">
                    ...
                    <li className='nav-logged'>Logged as "Harsh Gupta"</li>
                </div>
